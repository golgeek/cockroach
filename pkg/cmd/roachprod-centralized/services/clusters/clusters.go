...
func (s *Service) GetCluster(
	...
	if err != nil {
		if errors.Is(err, clusters.ErrClusterNotFound) {
			return nil, utils.NewPublicError(ErrClusterNotFound)
		}
		return nil, err
	}
...
func (s *Service) CreateCluster(
	...
	if err == nil {
		return nil, utils.NewPublicError(ErrClusterAlreadyExists)
	}
...
func (s *Service) DeleteCluster(
	...
	if err != nil {
		if errors.Is(err, clusters.ErrClusterNotFound) {
			return utils.NewPublicError(ErrClusterNotFound)
		}
		return err
	}
