...
// Note: Slice fields (CloudProviders, DNSProviders) are only configurable via config files
// due to TODO(golgeek) in processFieldsRecursive - this will be fixed in Phase 4
