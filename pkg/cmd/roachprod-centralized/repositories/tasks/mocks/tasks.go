...
func (_m *ITasksRepository) GetTasks(_a0 context.Context, _a1 *logger.Logger, _a2 filtertypes.FilterSet) ([]tasks.ITask, error) {
	ret := _m.Called(_a0, _a1, _a2)
	...
	var r0 []tasks.ITask
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *logger.Logger, filtertypes.FilterSet) ([]tasks.ITask, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *logger.Logger, filtertypes.FilterSet) []tasks.ITask); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]tasks.ITask)
...
func (_m *ITasksRepository) GetTasksForProcessing(_a0 context.Context, _a1 *logger.Logger, _a2 chan<- tasks.ITask, _a3 uuid.UUID) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *logger.Logger, chan<- tasks.ITask, uuid.UUID) error); ok {
