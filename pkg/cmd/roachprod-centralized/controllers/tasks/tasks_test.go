...
func TestGetAll(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			request: request{
				method: "GET",
				url:    "/tasks?unknown_field[gte]=2024-01-01",
			},
			serviceResult: serviceResult{},
			expected: expected{
				code:          http.StatusBadRequest,
		...
		},
		{
			...
			request: request{
				method: "GET",
				url:    "/tasks?type=test&state[ne]=failed",
			},
			serviceResult: serviceResult{},
			expected: expected{
				code: http.StatusOK,
		...
		},
		{
			...
			request: request{
				method: "GET",
				url:    "/tasks?state[in]=invalid,failed",
			},
			serviceResult: serviceResult{},
			expected: expected{
				code:          http.StatusBadRequest,
		...
		},
		{
			...
			request: request{
				method: "GET",
				url:    "/tasks?type=" + strings.Repeat("a", 51), // Exceed max=50 limit
			},
			serviceResult: serviceResult{},
			expected: expected{
				code:          http.StatusBadRequest,
