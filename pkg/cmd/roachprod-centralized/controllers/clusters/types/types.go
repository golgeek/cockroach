...
import (
	...
	clustermodels "github.com/cockroachdb/cockroach/pkg/cmd/roachprod-centralized/services/clusters/models"
...
// Validate performs security and business logic validation for InputCreateClusterDTO
func (dto *InputCreateClusterDTO) Validate() error {
...
func (dto *InputCreateClusterDTO) ToServiceInputCreateClusterDTO() clustermodels.InputCreateClusterDTO {
	return clustermodels.InputCreateClusterDTO{
		Cluster: dto.Cluster,
	}
}

// InputUpdateClusterDTO is input data transfer object that handles requests
// parameters for the clusters.Update() controller.
type InputUpdateClusterDTO struct {
	cloudcluster.Cluster
}

// Validate performs security and business logic validation for InputUpdateClusterDTO
func (dto *InputUpdateClusterDTO) Validate() error {
	// Validate cluster name
	if err := controllers.ValidateInputSecurity(dto.Cluster.Name, 64); err != nil {
		return err
	}
...
// to a clusters' service InputCreateClusterDTO.
func (dto *InputUpdateClusterDTO) ToServiceInputUpdateClusterDTO() clustermodels.InputUpdateClusterDTO {
	return clustermodels.InputUpdateClusterDTO{
		Cluster: dto.Cluster,
	}
}
