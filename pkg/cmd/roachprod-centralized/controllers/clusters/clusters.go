...
func (ctrl *Controller) Create(c *gin.Context) {
	var inputDTO types.InputCreateClusterDTO
...
// Update updates a cluster in the clusters service.
func (ctrl *Controller) Update(c *gin.Context) {
	var inputDTO types.InputUpdateClusterDTO
	if err := c.ShouldBindJSON(&inputDTO); err != nil {
		ctrl.Render(c, &controllers.BadRequestResult{Error: err})
		return
	}
...
func (ctrl *Controller) Delete(c *gin.Context) {
	...
	err := ctrl.service.DeleteCluster(
		c.Request.Context(),
		ctrl.GetRequestLogger(c),
		clustermodels.InputDeleteClusterDTO{
			Name: clusterName,
		},
	)
