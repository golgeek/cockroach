...
def go_deps():
    ...
    go_repository(
        ...
        strip_prefix = "github.com/samber/lo@v1.47.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/samber/lo/com_github_samber_lo-v1.47.0.zip",
        ],
    )
    go_repository(
        ...
        sha256 = "193b1f9ef27d0204fbff051ec61100415af10ff7aa8fe70b8e5e4a0fab1b00b9",
        strip_prefix = "github.com/samber/slog-multi@v1.3.3",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/samber/slog-multi/com_github_samber_slog_multi-v1.3.3.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/net/org_golang_x_net-v0.30.0.zip",
        ],
    )
    go_repository(
